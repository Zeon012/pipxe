...
install -m 644 /pi-gen/stage-gc/00-gadget_cdrom/files/meta-data "${ROOTFS_DIR}/boot/"
install -m 644 /pi-gen/stage-gc/00-gadget_cdrom/files/network-config "${ROOTFS_DIR}/boot/"
install -m 644 /pi-gen/stage-gc/00-gadget_cdrom/files/user-data "${ROOTFS_DIR}/boot/"
